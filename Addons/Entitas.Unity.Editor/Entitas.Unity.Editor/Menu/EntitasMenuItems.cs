...
namespace Entitas.Unity.Editor {
    ...
    public static class EntitasMenuItems {
        ...
        public const string preferences                      = "Commando/Entitas/Preferences... #%e";

        public const string check_for_updates                = "Commando/Entitas/Check for Updates...";

        public const string documentation                    = "Commando/Entitas/Documentation...";

        public const string feedback_report_a_bug            = "Commando/Entitas/Feedback/Report a bug...";
        public const string feedback_request_a_feature       = "Commando/Entitas/Feedback/Request a feature...";
        public const string feedback_join_the_entitas_chat   = "Commando/Entitas/Feedback/Join the Entitas chat...";
        public const string feedback_entitas_wiki            = "Commando/Entitas/Feedback/Entitas Wiki...";
        public const string feedback_donate                  = "Commando/Entitas/Feedback/Donate...";
    }
